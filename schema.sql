...
ALTER TABLE favourite_tracks ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE favourite_albums ADD COLUMN created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE albums
ADD COLUMN isExplicit TINYINT(1) DEFAULT 0;

ALTER TABLE tracks ADD COLUMN lyrics VARCHAR(255) DEFAULT "";